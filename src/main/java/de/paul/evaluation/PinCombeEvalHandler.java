...
public class PinCombeEvalHandler extends EvalHandler {

	private static final int DOCCOUNT = 50;
	private static PinCombeEvalHandler instance;

	private PinCombeEvalHandler(String string) {

		this.path = string;
	}

	public static PinCombeEvalHandler getInstance(String path) {

		if (instance == null)
			instance = new PinCombeEvalHandler(path);
		return instance;
	}

	public static void main(String[] args) throws IOException {

		PinCombeEvalHandler p = new PinCombeEvalHandler(
				Paths.PINCOMBE_EVAL_DATA);
		p.loadRows();
